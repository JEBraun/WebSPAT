...
#%% Plots figure of RMB image and ROI for each video
...
#%% Plots Otsu's Threshold along line graph
...
#%% Plots transect derived shoreline
...
#%% Plots beach transect pixel width figure
...
#%% Uses transect derived shoreline detection to identify shoreline on rectified images
    #Not used in current version of this toolkit
